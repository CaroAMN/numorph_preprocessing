numorph_preprocessing Executable
...
-run_numorph_preprocessing.sh (shell script for temporarily setting environment variables 
                               and executing the application)
   -to run the shell script, type
   
       ./run_numorph_preprocessing.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2023a, run the shell script as:
       ...
       ./run_numorph_preprocessing.sh /mathworks/home/application/R2023a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_numorph_preprocessing.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2023a/runtime/glnxa64:MR/R2023a/bin/glnxa64:MR/R2023a/sys/os/glnxa64:MR/R2023a/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_numorph_preprocessing.sh 
